...
const seedDB = async() => {
    ...
    for (let i = 0; i < 50; i++) {
        ...
        const camp = new Campground({
            ...
            description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem unde perspiciatis doloribus impedit, consectetur eligendi dignissimos dolores. Adipisci natus voluptas voluptate nam cumque perferendis dolorum praesentium, voluptatem perspiciatis, earum suscipit',
            price: randPrice,
            images: [
                {
